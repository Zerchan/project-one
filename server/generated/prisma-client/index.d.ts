...
export type Permission = "ADMIN" | "USER" | "GUARD" | "PERMISSIONUPDATE";
...
export interface ReservationCreateInput {
  ...
  endDate?: Maybe<TimeframeCreateOneInput>;
  comments?: Maybe<String>;
}
...
export interface TimeframeCreateOneInput {
  create?: Maybe<TimeframeCreateInput>;
}

export interface ReservationUpdateWithoutUserDataInput {
  userId?: Maybe<String>;
  status?: Maybe<Status>;
  startDate?: Maybe<TimeframeUpdateOneRequiredInput>;
  endDate?: Maybe<TimeframeUpdateOneInput>;
  comments?: Maybe<String>;
}
...
export interface ReservationUpdateInput {
  user?: Maybe<UserUpdateOneRequiredWithoutReservationsInput>;
  userId?: Maybe<String>;
  status?: Maybe<Status>;
  startDate?: Maybe<TimeframeUpdateOneRequiredInput>;
  endDate?: Maybe<TimeframeUpdateOneInput>;
...
export interface ReservationWhereInput {
  ...
  status_in?: Maybe<Status[] | Status>;
  status_not_in?: Maybe<Status[] | Status>;
  startDate?: Maybe<TimeframeWhereInput>;
  endDate?: Maybe<TimeframeWhereInput>;
  comments?: Maybe<String>;
  comments_not?: Maybe<String>;
  comments_in?: Maybe<String[] | String>;
  comments_not_in?: Maybe<String[] | String>;
...
export interface TimeframeUpdateOneInput {
  create?: Maybe<TimeframeCreateInput>;
  update?: Maybe<TimeframeUpdateDataInput>;
  upsert?: Maybe<TimeframeUpsertNestedInput>;
  delete?: Maybe<Boolean>;
  disconnect?: Maybe<Boolean>;
}

export interface TimeframeUpsertNestedInput {
...
export interface TimeframeUpdateOneRequiredInput {
  create?: Maybe<TimeframeCreateInput>;
  update?: Maybe<TimeframeUpdateDataInput>;
  upsert?: Maybe<TimeframeUpsertNestedInput>;
}
...
export interface ReservationPromise extends Promise<Reservation>, Fragmentable {
  ...
  startDate: <T = TimeframePromise>() => T;
  endDate: <T = TimeframePromise>() => T;
...
export interface ReservationSubscription
  ...
  startDate: <T = TimeframeSubscription>() => T;
  endDate: <T = TimeframeSubscription>() => T;
